 ...
 *
 * @author martin
 * @version $Id: FTLFileFilter.java,v 1.2 2006/07/06 06:58:34 martin Exp $
 */
public class FTLFileFilter extends FileFilter
{
    /** Create a new instance of PNGFileFilter */
    public FTLFileFilter()
    {
    }
    ...
    {
        return "Freemarker template files";
    }
}
