...
/*
 * SquareProjection.java
 *
 * Created on December 24, 2005, 2:34 PM
 *
 */
 ...
 *
 * @author martin
 * @version $Id: SquareProjection.java,v 1.8 2006/07/06 06:58:34 martin Exp $
 */
public class SquareProjection extends AbstractProjector implements Projector
{
    /** Our logging object */
    private static Log log = LogFactory.getLog(SquareProjection.class);

    /** Creates a new instance of SquareProjection */
    public SquareProjection()
    {
    }
     ...
     */
    public SquareProjection(AllPlanetParameters params)
    {
        super(params);
    }
                ...
                if (cos2 > 0.0)
                {
                    ...
                    for (i = 0; i < width; ++i)
                    {
                        ...
                        colours[i][j] = (short) planet0(
                                Math.cos(theta1) * cos2, Math.sin(y),
