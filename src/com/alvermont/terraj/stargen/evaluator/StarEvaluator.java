 ...
 * StarEvaluator.java
 *
 * Created on December 27, 2005, 10:14 AM
 *
 */
...
/**
 * Interface for classes that evaluate star characteristics
 *
 * @author martin
 * @version $Id: StarEvaluator.java,v 1.2 2006/07/06 06:58:36 martin Exp $
 */
public interface StarEvaluator
{
    /**
     ...
     *
     * @param star The star to be evaluated
     */
    public void evaluate(Primary star);
