 ...
 *
 * @author martin
 * @version $Id: PNGFileFilter.java,v 1.5 2006/07/06 06:58:34 martin Exp $
 */
public class PNGFileFilter extends FileFilter
{
    ...
    {
        return "PNG, JPG and BMP graphics files";
    }

    /**
     * Get a format name suitable for use with ImageIO
     *
     * @param target The target file to be written
     * @return The corresponding format name
     */
    public static String getFormatName(File target)
    {
        String format = "png";
