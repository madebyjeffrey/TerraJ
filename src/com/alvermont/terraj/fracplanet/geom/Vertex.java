 ...
 * Vertex.java
 *
 * Created on January 1, 2006, 9:16 AM
 *
 */
...
/**
 * Interface that must be implemented by objects that represent
 * vertices.
 *
 * @author martin
 * @version $Id: Vertex.java,v 1.4 2006/07/06 06:58:35 martin Exp $
 */
public interface Vertex
{
     ...
     */
    void setColour(int index, float red, float green, float blue);

    /**
     * Indexed setter for property colour.
     *
     * @param index Index of the property.
     * @param colour New value of the property at <CODE>index</CODE>.
     */
    void setColour(int index, ByteRGBA colour);
     ...
     * @param colour New value of the property at <CODE>index</CODE>.
     */
    void setColour(int index, FloatRGBA colour);

    /**
     * Indexed setter for property emissive.
     *
     * @param index Index of the property.
     * @param emissive New value of the property at <CODE>index</CODE>.
     */
    void setEmissive(int index, boolean emissive);
