...
public abstract class AbstractTerrainViewerFrame extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        org.jdesktop.layout.GroupLayout terrainPanelLayout =
            new org.jdesktop.layout.GroupLayout(terrainPanel);
        terrainPanel.setLayout(terrainPanelLayout);
        terrainPanelLayout.setHorizontalGroup(
            terrainPanelLayout.createParallelGroup(
                org.jdesktop.layout.GroupLayout.LEADING).add(
                0, 549, Short.MAX_VALUE));
        terrainPanelLayout.setVerticalGroup(
            terrainPanelLayout.createParallelGroup(
                org.jdesktop.layout.GroupLayout.LEADING).add(
                0, 503, Short.MAX_VALUE));
        ...
        loadParamsItem.addActionListener(
            new java.awt.event.ActionListener()
            {
                public void actionPerformed(java.awt.event.ActionEvent evt)
                {
        ...
        importParamsItem.setToolTipText(
            "Merge some settings from a file into this one");
        importParamsItem.addActionListener(
            new java.awt.event.ActionListener()
            {
                public void actionPerformed(java.awt.event.ActionEvent evt)
                {
        ...
        saveParamsItem.addActionListener(
            new java.awt.event.ActionListener()
            {
                public void actionPerformed(java.awt.event.ActionEvent evt)
                {
        ...
        showControlsHelpCheckbox.addActionListener(
            new java.awt.event.ActionListener()
            {
                public void actionPerformed(java.awt.event.ActionEvent evt)
                {
        ...
        showCameraDialogCheckbox.addActionListener(
            new java.awt.event.ActionListener()
            {
                public void actionPerformed(java.awt.event.ActionEvent evt)
                {
                    ...
                    layout.createParallelGroup(
                        ...
                        layout.createSequentialGroup().add(
                            layout.createParallelGroup(
                                ...
                                549, Short.MAX_VALUE).add(
                                terrainPanel,
                                org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                549, Short.MAX_VALUE)).addPreferredGap(
                        ...
                        org.jdesktop.layout.GroupLayout.TRAILING,
                        layout.createSequentialGroup().add(flyButton).addPreferredGap(
                            org.jdesktop.layout.LayoutStyle.RELATED, 427,
                            Short.MAX_VALUE).add(
                            controlsButton,
            ...
            layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
                ...
                layout.createSequentialGroup().addContainerGap().add(
                    layout.createParallelGroup(
                        ...
                        Short.MAX_VALUE).add(
                        org.jdesktop.layout.GroupLayout.TRAILING, tiltSlider,
                        org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 503,
                        Short.MAX_VALUE)).addPreferredGap(
                    org.jdesktop.layout.LayoutStyle.RELATED).add(
                    spinSlider, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,
                    org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                    org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).addPreferredGap(
                    org.jdesktop.layout.LayoutStyle.RELATED).add(
                    layout.createParallelGroup(
                        org.jdesktop.layout.GroupLayout.BASELINE).add(
                        controlsButton).add(flyButton)).addContainerGap()));
        pack();
