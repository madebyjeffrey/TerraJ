 ...
 * DummyProgress.java
 *
 * Created on December 29, 2005, 11:35 AM
 *
 */
...
/**
 * A dummy implementation of the progress interface that does nothing but
 * implement the methods with empty actions.
 *
 * @author martin
 * @version $Id: DummyProgress.java,v 1.2 2006/07/06 06:58:34 martin Exp $
 */
public class DummyProgress implements Progress
{
    /** Our logging object */
    private static Log log = LogFactory.getLog(DummyProgress.class);

    /** Creates a new instance of DummyProgress */
