...
<Workset version="7">
  <WorksetName>TerraJ</WorksetName>
  <Options auto-reload="no" />
  <Classpath shortContainerNames="yes">
    <ClasspathPart type="bin-class">/Users/drakej/Code/Java/TerraJ/target</ClasspathPart>
  </Classpath>
  <ViewFilters>
    ...
    <PatternFilter active="yes">com.*</PatternFilter>
  </ViewFilters>
  <IgnoreFilters>
